...
@Service
public class ListRegistrationSummariesUseCase
        implements UseCase<ListRegistrationSummariesRequest, RegistrationSummaryListResponse> {
    ...
    public ListRegistrationSummariesUseCase(
