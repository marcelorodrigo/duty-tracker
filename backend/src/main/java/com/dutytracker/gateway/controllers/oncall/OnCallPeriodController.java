...
public class OnCallPeriodController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "On-call period created successfully",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = OnCallPeriodResponse.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "On-call periods retrieved successfully",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = OnCallPeriodListResponse.class)))
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "On-call period retrieved successfully",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = OnCallPeriodResponse.class))),
            @ApiResponse(responseCode = "404", description = "On-call period not found")
    })
    public ResponseEntity<OnCallPeriodResponse> get(@Parameter(description = "On-call period ID") @PathVariable Long id) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "On-call period updated successfully",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = OnCallPeriodResponse.class))),
            @ApiResponse(responseCode = "400", description = "Invalid period data"),
            @ApiResponse(responseCode = "404", description = "On-call period not found")
    })
    public ResponseEntity<OnCallPeriodResponse> update(@Parameter(description = "On-call period ID") @PathVariable Long id,
    ...
    @Operation(summary = "Add holiday override", description = "Mark a specific date as a holiday within an on-call period")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Holiday override added successfully",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = OnCallPeriodResponse.class))),
            @ApiResponse(responseCode = "400", description = "Invalid holiday date"),
            @ApiResponse(responseCode = "404", description = "On-call period not found")
    })
    public ResponseEntity<OnCallPeriodResponse> addHoliday(@Parameter(description = "On-call period ID") @PathVariable Long id,
    ...
    public ResponseEntity<Void> removeHoliday(@Parameter(description = "On-call period ID") @PathVariable Long id,
    ...
    @Operation(summary = "Calculate on-call day entries", description = "Generate day entries for the entire on-call period")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Day entries calculated successfully",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = OnCallDayEntriesResponse.class))),
            @ApiResponse(responseCode = "404", description = "On-call period not found")
    })
    public ResponseEntity<OnCallDayEntriesResponse> calculate(@Parameter(description = "On-call period ID") @PathVariable Long id) {
    ...
    @Operation(summary = "Override day entry", description = "Modify hours, rate type, or time-for-time flag for a specific day entry")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Day entry overridden successfully",
