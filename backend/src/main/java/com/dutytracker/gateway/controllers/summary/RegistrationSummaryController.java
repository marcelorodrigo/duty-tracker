...
public class RegistrationSummaryController {
    ...
    @Operation(
            ...
            description = "Create a new registration summary for an on-call period")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "201",
                        description = "Registration summary created successfully",
                        content =
                                @Content(
                                        mediaType = "application/json",
                                        schema = @Schema(implementation = RegistrationSummaryResponse.class))),
    ...
    public ResponseEntity<RegistrationSummaryResponse> create(@RequestBody CreateSummaryBody body) {
        ...
        return ResponseEntity.created(URI.create("/api/v1/summaries/" + response.id()))
                .body(response);
    }
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Registration summaries retrieved successfully",
                        content =
                                @Content(
                                        mediaType = "application/json",
                                        schema = @Schema(implementation = RegistrationSummaryListResponse.class)))
            })
    ...
    @Operation(
            ...
            description = "Retrieve details of a specific registration summary")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    public ResponseEntity<RegistrationSummaryResponse> get(
    ...
    @Operation(
            summary = "Add on-call day entry",
            description = "Create a new on-call day entry within a registration summary")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "201",
                        description = "On-call day entry added successfully",
                        content =
                                @Content(
                                        mediaType = "application/json",
    ...
    public ResponseEntity<OnCallDayEntryResponse> addOnCallEntry(
        ...
        var response =
                addOnCallEntry.execute(new AddOnCallDayEntryRequest(id, body.date(), body.hours(), body.rateType()));
        return ResponseEntity.created(URI.create("/api/v1/summaries/" + id + "/oncall-entries/" + response.id()))
                .body(response);
    }

    @PutMapping("/{id}/oncall-entries/{entryId}")
    @Operation(
            summary = "Override on-call day entry",
            description = "Modify hours, rate type, or time-for-time flag for an on-call entry")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "On-call entry overridden successfully",
                        content =
                                @Content(
                                        mediaType = "application/json",
                                        schema = @Schema(implementation = OnCallDayEntryResponse.class))),
    ...
    @Operation(
            summary = "Delete on-call day entry",
            description = "Remove an on-call day entry from a registration summary")
    @ApiResponses(
            value = {
    ...
    @Operation(
            summary = "Add overtime entry",
            description = "Create a new overtime entry within a registration summary")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "201",
                        ...
                        content =
                                @Content(
                                        mediaType = "application/json",
                                        schema = @Schema(implementation = OvertimeEntryResponse.class))),
                @ApiResponse(responseCode = "400", description = "Invalid entry data")
            })
    public ResponseEntity<OvertimeEntryResponse> addOvertimeEntry(
            @Parameter(description = "Registration summary ID") @PathVariable Long id,
            @RequestBody AddOvertimeEntryBody body) {
        var response = addOvertimeEntry.execute(new AddOvertimeEntryRequest(
                body.incidentId(),
                body.overtimeHours(),
                body.allowanceHours(),
                body.allowancePercentage(),
                body.timeFrom(),
                body.timeTo(),
                body.isAllowanceEntry()));
        return ResponseEntity.created(URI.create("/api/v1/summaries/" + id + "/overtime-entries/" + response.id()))
                .body(response);
    }

    @PutMapping("/{id}/overtime-entries/{entryId}")
    @Operation(
            summary = "Override overtime entry",
            description = "Modify hours and allowance details for an overtime entry")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Overtime entry overridden successfully",
                        content =
                                @Content(
                                        mediaType = "application/json",
                                        schema = @Schema(implementation = OvertimeEntryResponse.class))),
    ...
    public ResponseEntity<OvertimeEntryResponse> overrideOvertimeEntry(
        ...
        return ResponseEntity.ok(overrideOvertimeEntry.execute(new OverrideOvertimeEntryRequest(
                entryId, body.overtimeHours(), body.allowanceHours(), body.allowancePercentage())));
    }
    ...
    record OvertimeEntryOverrideBody(
            BigDecimal overtimeHours, BigDecimal allowanceHours, BigDecimal allowancePercentage) {}
}
