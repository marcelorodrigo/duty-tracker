...
class GetRegistrationSummaryUseCaseTest {
    ...
    private static final RegistrationSummary SUMMARY =
            new RegistrationSummary(1L, "Week label", START_DATE, END_DATE, Instant.now(), Instant.now());
    ...
    void shouldReturnSummaryWithEntries() {
        ...
        when(onCallDayEntryGateway.findByOnCallPeriodId(10L))
                .thenReturn(List.of(new OnCallDayEntry(
                        ...
                        false,
                        false)));
        Incident incident = new Incident(20L, 10L, START_DATE, LocalTime.of(2, 0), LocalTime.of(3, 0), Instant.now());
