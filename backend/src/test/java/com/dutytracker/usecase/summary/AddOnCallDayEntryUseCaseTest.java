...
class AddOnCallDayEntryUseCaseTest {
    ...
    void shouldAddEntryWithManualOverrideTrue() {
        ...
        AddOnCallDayEntryRequest request =
                new AddOnCallDayEntryRequest(1L, date, BigDecimal.valueOf(24), StandbyRateType.WEEKDAY_SATURDAY);
    ...
    void shouldThrowWhenPeriodNotFound() {
        ...
        assertThatThrownBy(() -> useCase.execute(new AddOnCallDayEntryRequest(
                        99L, LocalDate.now(), BigDecimal.ONE, StandbyRateType.WEEKDAY_SATURDAY)))
