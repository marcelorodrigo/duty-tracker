...
class ListIncidentsUseCaseTest {
    ...
    void shouldReturnFilteredListWhenOnCallPeriodIdIsGiven() {
        // given
        var incident =
                new Incident(1L, 42L, "Test incident", FIXED_DATE_TIME, FIXED_DATE_TIME.plusHours(1), FIXED_DATE_TIME);
    ...
    void shouldReturnAllIncidentsWhenOnCallPeriodIdIsNull() {
        // given
        var i1 = new Incident(1L, 1L, "Incident one", FIXED_DATE_TIME, FIXED_DATE_TIME.plusHours(1), FIXED_DATE_TIME);
        var i2 = new Incident(2L, 5L, "Incident two", FIXED_DATE_TIME, FIXED_DATE_TIME.plusHours(1), FIXED_DATE_TIME);
