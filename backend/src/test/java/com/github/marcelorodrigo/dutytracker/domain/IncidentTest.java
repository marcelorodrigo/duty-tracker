...
class IncidentTest {
    ...
    void shouldRejectIncidentWithoutPositiveOnCallPeriodId(long onCallPeriodId) {
        ...
        // when / then
        assertThatThrownBy(() -> Incident.create(onCallPeriodId, "Database outage", START, end, START.minusDays(1)))
    ...
    void shouldRejectIncidentWithoutName() {
        ...
        // when / then
        assertThatThrownBy(() -> Incident.create(1L, " ", START, end, START.minusDays(1)))
                .isInstanceOf(InvalidIncidentException.class)
    ...
    void shouldRejectIncidentShorterThanOneMinute(long secondsAfterStart) {
        ...
        // when / then
        assertThatThrownBy(() -> Incident.create(1L, "Database outage", START, end, START.minusDays(1)))
                .isInstanceOf(InvalidIncidentException.class)
